...
Welcome! This guide will help you get started with the **C#** test project.

## Step 1: Read the Requirements

1. **Start here**: Read [TEST_REQUIREMENTS.md](./TEST_REQUIREMENTS.md) for complete C# test requirements
...
**POST/PUT endpoints** (you need to implement in C#):
...
4. **Finally Logging** (request logging in the C# backend)
