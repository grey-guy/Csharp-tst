# C# Developer Test - Quick Summary

## What You Need to Do

### Required Tasks (2–3 hours)

1. **Add User Creation** – `POST /api/users` (in C# backend)
...
4. **Add Request Logging**
   - Log method, path, status, duration for all C# backend requests
   - Use structured logging (ASP.NET Core ILogger or middleware)
...
- Write unit and integration tests (e.g., with xUnit)
- Follow C# & ASP.NET Core best practices
- Add documentation
...
- **25%** – C#/.NET best practices and idioms
