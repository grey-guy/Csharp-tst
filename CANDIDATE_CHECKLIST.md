# C# Candidate Checklist

Use this checklist to track your progress through the **C# developer** test.

## Phase 1: Setup (30 minutes)

- [ ] Forked/cloned the repository or set up `csharp-test/`
- [ ] Installed .NET 8 SDK
...
- [ ] Started C# backend on port 8080
...
### Request Logging
- [ ] Added logging for all C# backend requests
- [ ] Logs HTTP method
- [ ] Logs request path
